...
import { Plus, Search, Play, Edit, Trash2, Loader2, ChevronRight, Layout } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex space-x-4 items-center bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="text-sm text-gray-500">
          Showing {workloads.length} workflows
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 py-20 text-center">
          <div className="max-w-xs mx-auto space-y-4">
            ...
            <p className="text-gray-500 leading-relaxed">
              {search ? `No workflows match "${search}"` : "You haven't created any workflows yet. Get started by creating your first automated process."}
            </p>
            {!search && (
              <button 
                onClick={() => createMutation.mutate()}
